class Administrator::SubscribeController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @subscribe.update(subscribe_params)
        format.html { redirect_to administrator_subscribe_path(@subscribe), notice: 'Subscribe was successfully updated.' }
  ...
  def destroy
    @subscribe.destroy
    respond_to do |format|
      format.html { redirect_to administrator_subscribe_path(@subscribe), notice: 'Subscribe was successfully destroyed.' }
  ...
  private
    ...
    def subscribe_params
      params.require(:subscribe).permit(:user_id, :type)
    end
end
