class Administrator::PostTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @post_type.save
        format.html { redirect_to administrator_post_type_path(@post_type), notice: 'Post type was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @post_type.update(post_type_params)
        format.html { redirect_to administrator_post_type_path((@post_type)), notice: 'Post type was successfully updated.' }
  ...
  def destroy
    @post_type.destroy
    respond_to do |format|
      format.html { redirect_to administrator_post_types_path, notice: 'Post type was successfully destroyed.' }
  ...
  private
    ...
    def post_type_params
      params.require(:post_type).permit(:title, :description)
    end
end
